...
class KillSumSection extends PureComponent<Props> {
  allValue() {
    ...
    changeField('killSumThirtyFive', true);
    changeField('killSumThirtySix', true);
    changeField('killSumThirtySeven', true);
    changeField('killSumThirtyEight', true);
    changeField('killSumThirtyNine', true);
    changeField('killSumFourty', true);
  }
